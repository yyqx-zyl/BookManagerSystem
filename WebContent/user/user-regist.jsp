    ...
    <div id="container">
    	<div id="header">
    		<div id="tool-bar">&nbsp;&nbsp; 欢迎光临智远图书网，
    		 [<a href="${pageContext.request.contextPath}/user/user-login.jsp">请登录</a>]&nbsp;
    		 <a href="${pageContext.request.contextPath}/user/index.jsp">首页
    		</a>&nbsp;|&nbsp;<a href="${pageContext.request.contextPath}/user/cart.jsp">购物车</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|&nbsp;<a href="#">帮助</a></div>
